...
Proceso Sucursales
	...
	Para indice_art <- 0 Hasta 4 Hacer
		Escribir 'Ingrese precio artículo ', indice_art+1, ': ';
	...
	Para indice_sucursal <- 0 Hasta 3 Hacer
		Para indice_art <- 0 Hasta 4 Hacer
			Escribir 'Ingrese cantidad del artículo ', indice_art+1, ', en Sucursal ', indice_sucursal+1, ': ';
	...
	Para indice_art <- 0 Hasta 4 Hacer
		...
		Escribir 'Total artículo ', indice_art+1, ': ', Suma;
	FinPara
	...
	Escribir 'Sucursal con mayor recaudación: ', NumMayor;
FinProceso
